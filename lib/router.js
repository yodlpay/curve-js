...
export var swapPriceImpactFromRoute = function (amount, route, output, inputCoinDecimals, outputCoinDecimals, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        var _amount, _output, smallAmountIntBN, amountIntBN, contract, _smallAmount, _a, _route, _swapParams, _factorySwapAddresses, _smallOutput, e_2, priceImpactBN;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _amount = parseUnits(amount, inputCoinDecimals);
...
export var swapPriceImpact = function (inputCoin, outputCoin, amount, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, inputCoinAddress, outputCoinAddress, _b, inputCoinDecimals, outputCoinDecimals, _c, route, output;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _c = _d.sent(), route = _c.route, output = _c.output;
                    return [4 /*yield*/, swapPriceImpactFromRoute(amount, route, output, inputCoinDecimals, outputCoinDecimals, curveObj)];
