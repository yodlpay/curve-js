...
var PoolTemplate = /** @class */ (function () {
    function PoolTemplate(id, curveObj) {
        ...
        this.statsParameters = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        multicallContract = this.curve.contracts[this.address].multicallContract;
                        lpMulticallContract = this.curve.contracts[this.lpToken].multicallContract;
                        calls = [
                    ...
                    case 1:
                        _j.trys.push([1, 3, , 8]);
                        return [4 /*yield*/, this.curve.multicallProvider.all(calls)];
                    case 2:
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.curve.multicallProvider.all(calls)];
                    case 6:
                    ...
                    case 8:
                        ...
                        A_PRECISION = this.curve.chainId === 1 && ['compound', 'usdt', 'y', 'busd', 'susd', 'pax', 'ren', 'sbtc', 'hbtc', '3pool'].includes(this.id) ? 1 : 100;
                        return [4 /*yield*/, this.curve.multicallProvider.all(additionalCalls)];
                    case 9:
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            stablecoinContract = this.curve.contracts[this.underlyingCoinAddresses[0]].multicallContract;
                            collateralContract = this.curve.contracts[this.underlyingCoinAddresses[1]].multicallContract;
                            ammContract = this.curve.contracts[this.address].multicallContract;
                            return [4 /*yield*/, this.curve.multicallProvider.all([
                        ...
                        case 3:
                            ...
                            network = this.curve.constants.NETWORK_NAME;
        ...
        this.statsVolume = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (![56, 324, 1284, 2222, 8453, 42220, 1313161554].includes(this.curve.chainId)) return [3 /*break*/, 3];
        ...
        this.statsBaseApy = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (![56, 324, 1284, 2222, 8453, 42220, 1313161554].includes(this.curve.chainId)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Promise.all([
                                _getLegacyAPYsAndVolumes(this.curve.constants.NETWORK_NAME),
                                _getFactoryAPYsAndVolumes(this.curve.constants.NETWORK_NAME),
                            ])];
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            isDisabledChain = [1313161554].includes(this.curve.chainId);
                        ...
                        case 3:
                            ...
                            if (Number(totalLiquidityUSD) === 0)
                                return [2 /*return*/, [0, 0]];
                            if (!(this.curve.chainId !== 1)) return [3 /*break*/, 7];
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            lpTokenContract = this.curve.contracts[this.lpToken].multicallContract;
                            crvContract = this.curve.contracts[this.curve.constants.ALIASES.crv].contract;
                        ...
                        case 4:
                            ...
                            _c = toBN;
                            return [4 /*yield*/, crvContract.balanceOf(this.gauge, this.curve.constantOptions)];
                        case 5:
                        ...
                        case 7:
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            lpTokenContract = this.curve.contracts[this.lpToken].multicallContract;
                            gaugeControllerContract = this.curve.contracts[this.curve.constants.ALIASES.gauge_controller].multicallContract;
                            weightBN = void 0;
                            return [4 /*yield*/, this.curve.multicallProvider.all([
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, _getUsdRate(this.curve.constants.ALIASES.crv)];
                        case 10:
                            crvPrice = _g.sent();
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 4:
                            ...
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            lpTokenContract = this.curve.contracts[this.lpToken].multicallContract;
                            rewardContract = this.curve.contracts[this.sRewardContract || this.gauge].multicallContract;
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            e_2 = _c.sent();
                            lpContract = this.curve.contracts[this.lpToken].contract;
                            return [4 /*yield*/, lpContract.totalSupply(this.curve.constantOptions)];
                        case 4:
                        ...
                        case 6:
                            ...
                            contract = this.curve.contracts[this.curve.constants.ALIASES.stable_calc].contract;
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            if (!(this.curve.chainId !== 1)) return [3 /*break*/, 4];
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            crvContract = this.curve.contracts[this.curve.constants.ALIASES.crv].contract;
                            currentWeek = Math.floor(Date.now() / 1000 / WEEK);
                            return [4 /*yield*/, this.curve.multicallProvider.all([
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            votingEscrowContract = this.curve.contracts[this.curve.constants.ALIASES.voting_escrow].multicallContract;
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            ...
                            return [4 /*yield*/, this.curve.multicallProvider.all(contractCalls)];
                        case 1:
                            _response = _f.sent();
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 2:
                            gaugeContract = this.curve.contracts[this.gauge].contract;
                            gaugeMulticallContract = this.curve.contracts[this.gauge].multicallContract;
                            ...
                            return [4 /*yield*/, gaugeContract.reward_count(this.curve.constantOptions)];
                        case 3:
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, this.curve.multicallProvider.all(tokenCalls)];
                        case 5:
                            tokens = (_f.sent())
                            ...
                            for (_i = 0, tokens_1 = tokens; _i < tokens_1.length; _i++) {
                                ...
                                tokenMulticallContract = this.curve.contracts[token].multicallContract;
                                tokenInfoCalls.push(tokenMulticallContract.symbol(), tokenMulticallContract.decimals());
                            }
                            return [4 /*yield*/, this.curve.multicallProvider.all(tokenInfoCalls)];
                        case 6:
                            tokenInfo_1 = _f.sent();
                            for (i = 0; i < tokens.length; i++) {
                                this.curve.constants.DECIMALS[tokens[i]] = tokenInfo_1[(i * 2) + 1];
                            }
                        ...
                        case 7:
                            ...
                            rewardContract = this.curve.contracts[this.sRewardContract].contract;
                            method = "snx()" in rewardContract ? "snx" : "rewardsToken" // susd, tbtc : dusd, musd, rsv, sbtc
                            ;
                            return [4 /*yield*/, rewardContract[method](this.curve.constantOptions)];
                        case 8:
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 1:
                            ...
                            gaugeContract = this.curve.contracts[this.gauge].multicallContract;
                            result = [];
                            if (!('reward_data(address)' in this.curve.contracts[this.gauge].contract)) return [3 /*break*/, 7];
                        ...
                        case 7:
                            if (!(this.sRewardContract && "rewardRate()" in this.curve.contracts[this.sRewardContract].contract && "periodFinish()" && rewardTokens.length === 1)) return [3 /*break*/, 10];
                            rewardToken = rewardTokens[0];
                            sRewardContract = this.curve.contracts[this.sRewardContract].multicallContract;
                            return [4 /*yield*/, this.curve.multicallProvider.all([
        ...
        this._getCoinIdx = function (coin, useUnderlying, curveObj) {
            if (useUnderlying === void 0) { useUnderlying = true; }
            if (curveObj === void 0) { curveObj = curve; }
            ...
            var coinAddress = _getCoinAddresses(curveObj, coin)[0];
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        _d = (_c = _rates).push;
                        return [4 /*yield*/, this.curve.contracts[addr].contract.exchangeRateStored()];
                    case 2:
                        _d.apply(_c, [_g.sent()]);
                        return [3 /*break*/, 6];
                    case 3:
                        ...
                        _f = (_e = _rates).push;
                        return [4 /*yield*/, this.curve.contracts[addr].contract.getPricePerFullShare()];
                    case 4:
                        _f.apply(_e, [_g.sent()]);
                        return [3 /*break*/, 6];
                    case 5:
        ...
        var poolData = curveObj.getPoolsData()[id];
        this.curve = curveObj;
        this.id = id;
    ...
    PoolTemplate.prototype.hasVyperVulnerability = function () {
        var _c, _d;
        if (this.curve.chainId === 1 && this.id === "crveth")
            return true;
        if (this.curve.chainId === 42161 && this.id === "tricrypto")
            return true;
        // @ts-ignore
        ...
        }[this.curve.chainId]) !== null && _c !== void 0 ? _c : [];
    ...
    PoolTemplate.prototype.rewardsOnly = function () {
        ...
        if (this.gauge === curve.constants.ZERO_ADDRESS)
            throw Error("".concat(this.name, " doesn't have gauge"));
        var gaugeContract = this.curve.contracts[this.gauge].contract;
    ...
    PoolTemplate.prototype.statsWrappedBalances = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        contract = this.curve.contracts[this.address].multicallContract;
                        calls = [];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        contract = this.curve.contracts[calcContractAddress].contract;
                        ...
                        return [4 /*yield*/, contract.calc_token_amount(this.address, _amounts, isDeposit, this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.sent()];
                    case 2: return [4 /*yield*/, contract.calc_token_amount(this.address, _amounts, this.curve.constantOptions)];
                    case 3: return [2 /*return*/, _c.sent()];
                    case 4:
                        if (!("calc_token_amount(uint256[".concat(N_coins, "],bool)") in contract)) return [3 /*break*/, 6];
                        return [4 /*yield*/, contract.calc_token_amount(_amounts, isDeposit, this.curve.constantOptions)];
                    case 5: return [2 /*return*/, _c.sent()];
                    case 6: return [4 /*yield*/, contract.calc_token_amount(_amounts, this.curve.constantOptions)];
                    case 7: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = toBN;
                        return [4 /*yield*/, this.curve.contracts[this.address].contract.price_scale(this.curve.constantOptions)];
                    case 1:
    ...
    PoolTemplate.prototype.depositIsApproved = function (amounts) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, hasAllowance(this.underlyingCoinAddresses, amounts, this.curve.signerAddress, this.zap || this.address)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hasAllowance(this.wrappedCoinAddresses, amounts, this.curve.signerAddress, this.address)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hasAllowance([this.lpToken], [lpTokenAmount], this.curve.signerAddress, this.gauge)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = smartNumber;
                        return [4 /*yield*/, this.curve.contracts[this.gauge].contract.deposit.estimateGas(_lpTokenAmount, this.curve.constantOptions)];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.curve.contracts[this.gauge].contract.deposit(_lpTokenAmount, __assign(__assign({}, this.curve.options), { gasLimit: gasLimit }))];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _lpTokenAmount = parseUnits(lpTokenAmount);
                        _c = smartNumber;
                        return [4 /*yield*/, this.curve.contracts[this.gauge].contract.withdraw.estimateGas(_lpTokenAmount, this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.apply(void 0, [_d.sent()])];
                }
            });
        });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.curve.contracts[this.gauge].contract.withdraw(_lpTokenAmount, __assign(__assign({}, this.curve.options), { gasLimit: gasLimit }))];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.curve.contracts[this.gauge].contract.claimable_tokens(address, this.curve.constantOptions)];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (!(this.curve.chainId === 1)) return [3 /*break*/, 2];
                        _c = Number;
                        return [4 /*yield*/, this.curve.contracts[this.curve.constants.ALIASES.minter].contract.mint.estimateGas(this.gauge, this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.apply(void 0, [_e.sent()])];
                    case 2:
                        _d = smartNumber;
                        return [4 /*yield*/, this.curve.contracts[this.curve.constants.ALIASES.gauge_factory].contract.mint.estimateGas(this.gauge, this.curve.constantOptions)];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (this.rewardsOnly())
                            throw Error("".concat(this.name, " has Rewards-Only Gauge. Use claimRewards instead"));
                        contract = this.curve.chainId === 1 ? this.curve.contracts[this.curve.constants.ALIASES.minter].contract : this.curve.contracts[this.curve.constants.ALIASES.gauge_factory].contract;
                        _c = mulBy1_3;
                        _d = DIGas;
                        return [4 /*yield*/, contract.mint.estimateGas(this.gauge, this.curve.constantOptions)];
                    case 1:
                        gasLimit = _c.apply(void 0, [_d.apply(void 0, [_e.sent()])]);
                        return [4 /*yield*/, contract.mint(this.gauge, __assign(__assign({}, this.curve.options), { gasLimit: gasLimit }))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, gaugeContract.claimable_reward(address, rewardToken.token, this.curve.constantOptions)];
                    case 3:
                        _amount = _c.sent();
                        rewards.push({
                            token: rewardToken.token,
                    ...
                    case 6:
                        ...
                        rewardToken = rewardTokens[0];
                        return [4 /*yield*/, gaugeContract.claimable_reward(address, this.curve.constantOptions)];
                    case 7:
                        _totalAmount = _c.sent();
                        return [4 /*yield*/, gaugeContract.claimed_rewards_for(address, this.curve.constantOptions)];
                    case 8:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = smartNumber;
                        return [4 /*yield*/, gaugeContract.claim_rewards.estimateGas(this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.apply(void 0, [_d.sent()])];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        gasLimit = _c.apply(void 0, [_d.apply(void 0, [_e.sent()])]);
                        return [4 /*yield*/, gaugeContract.claim_rewards(__assign(__assign({}, this.curve.options), { gasLimit: gasLimit }))];
                    case 2: return [2 /*return*/, (_e.sent()).hash];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hasAllowance(this.underlyingCoinAddresses, amounts, this.curve.signerAddress, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                        coinsAllowance = _c.sent();
                        gaugeContract = this.curve.contracts[this.gauge].contract;
                        if (!('approved_to_deposit' in gaugeContract)) return [3 /*break*/, 3];
                        return [4 /*yield*/, gaugeContract.approved_to_deposit(this.curve.constants.ALIASES.deposit_and_stake, this.curve.signerAddress, this.curve.constantOptions)];
                    case 2:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ensureAllowanceEstimateGas(this.underlyingCoinAddresses, amounts, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                    ...
                    case 2:
                        ...
                        _c = smartNumber;
                        return [4 /*yield*/, gaugeContract.set_approve_deposit.estimateGas(this.curve.constants.ALIASES.deposit_and_stake, true, this.curve.constantOptions)];
                    case 3:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ensureAllowance(this.underlyingCoinAddresses, amounts, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, gaugeContract.set_approve_deposit(this.curve.constants.ALIASES.deposit_and_stake, true, __assign(__assign({}, this.curve.options), { gasLimit: gasLimit }))];
                    case 4:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hasAllowance(this.wrappedCoinAddresses, amounts, this.curve.signerAddress, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                        coinsAllowance = _c.sent();
                        gaugeContract = this.curve.contracts[this.gauge].contract;
                        if (!('approved_to_deposit' in gaugeContract)) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ensureAllowanceEstimateGas(this.wrappedCoinAddresses, amounts, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                        approveCoinsGas = _d.sent();
                        gaugeContract = this.curve.contracts[this.gauge].contract;
                        if (!('approved_to_deposit' in gaugeContract)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (this.isPlain || this.isFake)
                            throw Error("depositAndStakeWrappedApprove method doesn't exist for pool ".concat(this.name, " (id: ").concat(this.name, ")"));
                        return [4 /*yield*/, ensureAllowance(this.wrappedCoinAddresses, amounts, this.curve.constants.ALIASES.deposit_and_stake)];
                    case 1:
                        approveCoinsTx = _d.sent();
                        gaugeContract = this.curve.contracts[this.gauge].contract;
                        if (!('approved_to_deposit' in gaugeContract)) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 12:
                        ...
                        contract = this.curve.contracts[this.curve.constants.ALIASES.deposit_and_stake].contract;
                    ...
                    case 16:
                        ...
                        maxCoins = this.curve.chainId === 137 ? 6 : 5;
                        for (i = 0; i < maxCoins; i++) {
                            coinAddresses[i] = coinAddresses[i] || curve.constants.ZERO_ADDRESS;
                            _amounts[i] = _amounts[i] || curve.parseUnits("0");
                        }
                        return [4 /*yield*/, contract.deposit_and_stake.estimateGas(depositAddress, this.lpToken, this.gauge, coins.length, coinAddresses, _amounts, _minMintAmount, useUnderlying, this.isMetaFactory && isUnderlying ? this.address : curve.constants.ZERO_ADDRESS, __assign(__assign({}, this.curve.constantOptions), { value: value }))];
                    case 17:
                        _gas = (_q.sent());
                        if (estimateGas)
                    ...
                    case 18:
                        ...
                        return [4 /*yield*/, contract.deposit_and_stake(depositAddress, this.lpToken, this.gauge, coins.length, coinAddresses, _amounts, _minMintAmount, useUnderlying, this.isMetaFactory && isUnderlying ? this.address : curve.constants.ZERO_ADDRESS, __assign(__assign({}, this.curve.options), { gasLimit: gasLimit, value: value }))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hasAllowance([this.lpToken], [lpTokenAmount], this.curve.signerAddress, this.zap)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, hasAllowance([this.lpToken], [curve.formatUnits(_maxBurnAmount, 18)], this.curve.signerAddress, this.zap)];
                    case 2: return [2 /*return*/, _c.sent()];
                ...
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.curve.multicallProvider.all([
                                ...
                                this.curve.contracts[this.gauge].multicallContract.totalSupply(),
                            ])];
                    case 2:
                    ...
                    case 3:
                        _d = (_c = curve).formatUnits;
                        return [4 /*yield*/, this.curve.contracts[this.lpToken].contract.totalSupply(this.curve.constantOptions)];
                    case 4:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        contract = this.curve.contracts[contractAddress].contract;
                        if (!('get_dy_underlying' in contract)) return [3 /*break*/, 2];
                        return [4 /*yield*/, contract.get_dy_underlying(i, j, _amount, this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.sent()];
                    case 2:
                        if (!('get_dy(address,uint256,uint256,uint256)' in contract)) return [3 /*break*/, 4];
                        return [4 /*yield*/, contract.get_dy(this.address, i, j, _amount, this.curve.constantOptions)];
                    case 3: // atricrypto3 based metapools
                    return [2 /*return*/, _c.sent()];
                    case 4: return [4 /*yield*/, contract.get_dy(i, j, _amount, this.curve.constantOptions)];
                    case 5: return [2 /*return*/, _c.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        i = this._getCoinIdx(inputCoin);
                        return [4 /*yield*/, hasAllowance([this.underlyingCoinAddresses[i]], [amount], this.curve.signerAddress, contractAddress)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
    ...
    PoolTemplate.prototype._swapWrappedExpected = function (i, j, _amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.curve.contracts[this.address].contract.get_dy(i, j, _amount, this.curve.constantOptions)];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        });
