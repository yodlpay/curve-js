    ...
    function PoolTemplate(id, curveObj) {
        ...
        this.statsVolume = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (![324, 1284, 2222, 8453, 42220, 1313161554].includes(this.curve.chainId)) return [3 /*break*/, 3];
        ...
        this.statsBaseApy = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (![324, 1284, 2222, 8453, 42220, 1313161554].includes(this.curve.chainId)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Promise.all([
                                _getLegacyAPYsAndVolumes(this.curve.constants.NETWORK_NAME),
                                _getFactoryAPYsAndVolumes(this.curve.constants.NETWORK_NAME),
                            ])];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (this.rewardsOnly())
                            throw Error("".concat(this.name, " has Rewards-Only Gauge. Use claimRewards instead"));
                        contract = this.curve.contracts[this.curve.constants.ALIASES.minter].contract;
                        _c = mulBy1_3;
