...
import { getBestRouteAndOutput, getArgs, swapExpected, swapRequired, swapPriceImpact, swapIsApproved, swapApproveEstimateGas, swapApprove, swapEstimateGas, swap, getSwappedAmount, _getBestRoute, _getOutputForRoute, _findRoutes, swapPriceImpactFromRoute, } from "./router.js";
...
var router = {
    findAllRoutes: _findRoutes,
    getBestRoute: _getBestRoute,
    getBestRouteAndOutput: getBestRouteAndOutput,
    getOutputForRoute: _getOutputForRoute,
    expected: swapExpected,
    priceImpact: swapPriceImpact,
