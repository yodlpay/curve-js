...
export var _getCoinAddressesNoCheck = function (curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    var coins = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        coins[_i - 1] = arguments[_i];
    }
    if (coins.length == 1 && Array.isArray(coins[0]))
        coins = coins[0];
    coins = coins;
    return coins.map(function (c) { return c.toLowerCase(); }).map(function (c) { return curveObj.constants.COINS[c] || c; });
};
export var _getCoinAddresses = function (curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    var coins = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        coins[_i - 1] = arguments[_i];
    }
    var coinAddresses = _getCoinAddressesNoCheck.apply(void 0, __spreadArray([curveObj], coins, false));
    var availableAddresses = __spreadArray(__spreadArray([], Object.keys(curveObj.constants.DECIMALS), true), curveObj.constants.GAUGES, true);
...
export var _getCoinDecimals = function (curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    var coinAddresses = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        coinAddresses[_i - 1] = arguments[_i];
    }
    if (coinAddresses.length == 1 && Array.isArray(coinAddresses[0]))
        coinAddresses = coinAddresses[0];
    coinAddresses = coinAddresses;
    return coinAddresses.map(function (coinAddr) { var _a; return (_a = curveObj.constants.DECIMALS[coinAddr.toLowerCase()]) !== null && _a !== void 0 ? _a : 18; }); // 18 for gauges
};
export var _getBalances = function (coins, addresses, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    coinAddresses = _getCoinAddresses(curveObj, coins);
                    decimals = _getCoinDecimals(curveObj, coinAddresses);
                    ...
                    _loop_1 = function (coinAddr) {
                        contractCalls.push.apply(contractCalls, addresses.map(function (address) { return curveObj.contracts[coinAddr].multicallContract.balanceOf(address); }));
                    };
                    for (_i = 0, coinAddresses_2 = coinAddresses; _i < coinAddresses_2.length; _i++) {
                        coinAddr = coinAddresses_2[_i];
                        _loop_1(coinAddr);
                    }
                    return [4 /*yield*/, curveObj.multicallProvider.all(contractCalls)];
                case 1:
                    _response = _e.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, curveObj.provider.getBalance(address)];
                case 3:
                    _c.apply(_b, [_e.sent()]);
                    _e.label = 4;
                case 4:
                ...
                case 6:
                    ...
                    for (_d = 0, addresses_2 = addresses; _d < addresses_2.length; _d++) {
                        ...
                        balances[address] = _balances[address].map(function (b, i) { return curveObj.formatUnits(b, decimals[i]); });
                    }
...
export var _getAllowance = function (coins, address, spender, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, curveObj.contracts[_coins[0]].contract.allowance(address, spender, curveObj.constantOptions)];
                case 1:
                    allowance = [_a.sent()];
                    return [3 /*break*/, 4];
                case 2:
                    contractCalls = _coins.map(function (coinAddr) { return curveObj.contracts[coinAddr].multicallContract.allowance(address, spender); });
                    return [4 /*yield*/, curveObj.multicallProvider.all(contractCalls)];
                case 3:
                    allowance = _a.sent();
                    _a.label = 4;
...
// coins can be either addresses or symbols
export var getAllowance = function (coins, address, spender, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    coinAddresses = _getCoinAddresses(curveObj, coins);
                    decimals = _getCoinDecimals(curveObj, coinAddresses);
                    return [4 /*yield*/, _getAllowance(coinAddresses, address, spender, curveObj)];
                case 1:
                    _allowance = _a.sent();
...
// coins can be either addresses or symbols
export var hasAllowance = function (coins, amounts, address, spender, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
...
export var _ensureAllowance = function (coins, amounts, spender, isMax, curveObj) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    address = curveObj.signerAddress;
                    return [4 /*yield*/, _getAllowance(coins, address, spender, curveObj)];
                case 1:
                    allowance = _j.sent();
                    txHashes = [];
                    i = 0;
                ...
                case 2:
                    ...
                    contract = curveObj.contracts[coins[i]].contract;
                    _approveAmount = isMax ? MAX_ALLOWANCE : amounts[i];
                    return [4 /*yield*/, curveObj.updateFeeData()];
                case 3:
                    _j.sent();
                    if (!(allowance[i] > curveObj.parseUnits("0"))) return [3 /*break*/, 6];
                    _a = mulBy1_3;
                    _b = DIGas;
                    return [4 /*yield*/, contract.approve.estimateGas(spender, curveObj.parseUnits("0"), curveObj.constantOptions)];
                case 4:
                    gasLimit_1 = _a.apply(void 0, [_b.apply(void 0, [_j.sent()])]);
                    _d = (_c = txHashes).push;
                    return [4 /*yield*/, contract.approve(spender, curveObj.parseUnits("0"), __assign(__assign({}, curveObj.options), { gasLimit: gasLimit_1 }))];
                case 5:
                ...
                case 6:
                    _e = mulBy1_3;
                    _f = DIGas;
                    return [4 /*yield*/, contract.approve.estimateGas(spender, _approveAmount, curveObj.constantOptions)];
                case 7:
                    gasLimit = _e.apply(void 0, [_f.apply(void 0, [_j.sent()])]);
                    _h = (_g = txHashes).push;
                    return [4 /*yield*/, contract.approve(spender, _approveAmount, __assign(__assign({}, curveObj.options), { gasLimit: gasLimit }))];
                case 8:
...
// coins can be either addresses or symbols
export var ensureAllowanceEstimateGas = function (coins, amounts, spender, isMax, curveObj) {
    if (isMax === void 0) { isMax = true; }
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    contract = curveObj.contracts[coinAddresses[i]].contract;
                    _approveAmount = isMax ? MAX_ALLOWANCE : _amounts[i];
                    if (!(allowance[i] > curveObj.parseUnits("0"))) return [3 /*break*/, 4];
                    _a = smartNumber;
                    return [4 /*yield*/, contract.approve.estimateGas(spender, curveObj.parseUnits("0"), curveObj.constantOptions)];
                case 3:
...
// coins can be either addresses or symbols
export var ensureAllowance = function (coins, amounts, spender, isMax, curveObj) {
    if (isMax === void 0) { isMax = true; }
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    decimals = _getCoinDecimals(curveObj, coinAddresses);
                    _amounts = amounts.map(function (a, i) { return parseUnits(a, decimals[i]); });
                    return [4 /*yield*/, _ensureAllowance(coinAddresses, _amounts, spender, isMax, curveObj)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
};
export var getPoolIdBySwapAddress = function (swapAddress, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    var poolsData = curveObj.getPoolsData();
...
var _usdRatesCache = {};
export var _getUsdRate = function (assetId, curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (curveObj.chainId === 1 && assetId.toLowerCase() === '0x8762db106b2c2a0bccb3a80d1ed41273552616e8')
                ...
                case 1:
                    ...
                    if (assetId === 'USD' || (curveObj.chainId === 137 && (assetId.toLowerCase() === curveObj.constants.COINS.am3crv.toLowerCase())))
                        return [2 /*return*/, 1];
                    chainName = {
                        1: 'ethereum',
                    ...
                    if (curveObj.chainId === 137 && assetId.toLowerCase() === curveObj.constants.COINS.eurt) {
                        chainName = 'ethereum';
                        assetId = '0xC581b735A1688071A1746c968e0798D642EDE491'.toLowerCase(); // EURT Ethereum
                    }
                    // CRV
                    if (assetId.toLowerCase() === curveObj.constants.ALIASES.crv) {
...
export var getUsdRate = function (curveObj, coin) {
    if (curveObj === void 0) { curveObj = curve; }
    return __awaiter(void 0, void 0, void 0, function () {
        var coinAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    coinAddress = _getCoinAddressesNoCheck(curveObj, coin)[0];
                    return [4 /*yield*/, _getUsdRate(coinAddress, curveObj)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
export var getCoinsData = function (curveObj) {
    if (curveObj === void 0) { curveObj = curve; }
    var coins = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        coins[_i - 1] = arguments[_i];
            ...
            switch (_b.label) {
                case 0:
                    if (coins.length == 1 && Array.isArray(coins[0]))
                        coins = coins[0];
                    coins = coins;
                    coinAddresses = _getCoinAddressesNoCheck(curveObj, coins);
